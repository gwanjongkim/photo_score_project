...
from src.models.rgnet_paper import MODEL_VARIANT, get_rgnet_paper_custom_objects
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate RGNet-paper-v0 AADB regression outputs.")
...
def main() -> None:
    ...
    output_dir = Path(_resolve(args.output_dir, config, "evaluation", "output_dir", "outputs/rgnet_paper_aadb_regression_20260509/eval"))
    model_name = _resolve(args.model_name, config, "evaluation", "model_name", "rgnet_paper_v0_aadb_regression")
