...
from src.models.rgnet import build_rgnet_model
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a practical RGNet-style composition-aware aesthetics model.")
    ...
    model = build_rgnet_model(input_shape=(args.image_size, args.image_size, 3))
    model.compile(
