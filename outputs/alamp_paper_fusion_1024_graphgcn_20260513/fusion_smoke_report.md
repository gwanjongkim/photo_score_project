...
```bash
PYTHONPATH=. /home/omen_pc1/photo_score_project/.venv_gpu/bin/python src/train/train_alamp_paper_mpnet_graph_fusion.py --fusion_mode graphgcn --max_train_samples 1024 --max_val_samples 1024 --batch_size 16 --epochs 20 --learning_rate 1e-4 --out_dir outputs/alamp_paper_fusion_1024_graphgcn_20260513 --allow_val_selected_mpnet --save_model
```
...
```json
{
  "graphgcn": {
    ...
    "saved_model": "outputs/alamp_paper_fusion_1024_graphgcn_20260513/graphgcn/final_model.keras"
  }
}
```
