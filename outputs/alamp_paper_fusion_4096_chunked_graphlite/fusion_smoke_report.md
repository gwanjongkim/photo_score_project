...
```json
{
  ...
  "train_feature_cache": {
    ...
    "path": "outputs/alamp_paper_fusion_4096_chunked_graphlite/features/train_mpnet_features.npz",
    "status": "extracted"
  },
  "val_feature_cache": {
    "metadata": {
    ...
    "path": "outputs/alamp_paper_fusion_4096_chunked_graphlite/features/val_mpnet_features.npz",
    "status": "extracted"
  }
}
```
...
```json
{
  "graphlite": {
    ...
    "saved_model": "outputs/alamp_paper_fusion_4096_chunked_graphlite/graphlite/final_model.keras"
  }
}
```
