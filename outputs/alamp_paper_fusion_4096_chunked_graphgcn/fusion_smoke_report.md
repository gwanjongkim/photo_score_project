...
```json
{
  ...
  "train_feature_cache": {
    ...
    "path": "outputs/alamp_paper_fusion_4096_chunked_graphgcn/features/train_mpnet_features.npz",
    "status": "reused"
  },
  "val_feature_cache": {
    "metadata": {
    ...
    "path": "outputs/alamp_paper_fusion_4096_chunked_graphgcn/features/val_mpnet_features.npz",
    "status": "reused"
  }
}
```
...
```json
{
  "graphgcn": {
    ...
    "saved_model": "outputs/alamp_paper_fusion_4096_chunked_graphgcn/graphgcn/final_model.keras"
  }
}
```
